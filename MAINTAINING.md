...
We have a [template repo](https://github.com/micronaut-projects/micronaut-ols) that we use as the single
...
[Release GitHub Action workflow](https://github.com/micronaut-projects/micronaut-ols/blob/master/.github/workflows/release.yml)
